...
from mi_primera_app.models import Topic, Webpage, AccessRecord, ElProfe, Comments, ToyotaLegacy
from . import forms
...
def index(request):
    ...
    toyota_legacy_list = ToyotaLegacy.objects.order_by('email')
    my_context = {'username': 'Hola desde views.py',
                  'access_records': access_list,
                  'el_profe': elprofe_list,
                  'toyota_legacy': toyota_legacy_list}
